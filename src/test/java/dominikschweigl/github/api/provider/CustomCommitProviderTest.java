...
public class CustomCommitProviderTest {
    public static final CommitProviderFactory providerFactory = new ApacheCommitProviderFactory();

    @Test void CommitProviderDoesNotContainCommit() {
        CommitProvider commitsFinder = providerFactory.create(List.of());

        Assertions.assertThrows(IOException.class, () -> commitsFinder.getCommitsStartingAt("D"));
    }
